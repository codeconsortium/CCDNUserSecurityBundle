			...
			->children()
				->arrayNode('login_shield')
					...
					->children()
						...
						->scalarNode('login_fail_limit_recover_account')->defaultValue(25)->end()
						->scalarNode('login_fail_limit_http_500')->defaultValue(25)->end()
						->scalarNode('minutes_blocked_for')->defaultValue(10)->end()
